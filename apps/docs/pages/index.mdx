...
UniLLM is an TypeScript library that enables you to interact with any LLM (Large Language Model) via a unified API - the OpenAI API, in a type-safe way.

## Benefits
- ✨ Integrate with any provider and model using a unified interface (OpenAI)
...
- ⏩ Seamless integration with A/B testing tools without requiring a full release cycle
